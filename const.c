...
/*====== MACRO LOCALI =======================================================*/
/*====== DEFINIZIONI COSTANTI GENERALI ===================================== */

// costanti locali
//__psv__ const BootloaderPointers_T  *BLT_Pointer = 0x200;
 
const unsigned long Pow10[8] = {1, 10, 100, 1000, 10000, 100000, 1000000, 10000000};

const unsigned short ShortBit[] = {0x0001, 0x0002, 0x0004, 0x0008, 0x0010, 0x0020, 0x0040, 0x0080,
                              0x0100, 0x0200, 0x0400, 0x0800, 0x1000, 0x2000, 0x4000, 0x8000};                 

const unsigned char MaskNibble[2] = {0xF0, 0x0F};
const unsigned char MaskBitOr[8]  = {0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80};
const unsigned char MaskBitAnd[8] = {0xFE, 0xFD, 0xFB, 0xF7, 0xEF, 0xDF, 0xBF, 0x7F};
